...
class StarCoder:
    def __init__(
        ...
        # checkpoint = "/home/useradmin/LXQ/CodeQwen1.5-7B-Chat"
        # checkpoint = "/home/useradmin/LXQ/CodeQwen1.5-7B"
        # checkpoint = "/home/useradmin/LXQ/qwen2-7b-instruct"  ##
        # checkpoint = "/home/useradmin/LXQ/Qwen2.5-7B-Instruct" # sql测试用例无法正常执行
        # checkpoint = "/home/useradmin/LXQ/Qwen2.5-Coder-7B" #均有语法语义错误，大部分测试用例为空
        # checkpoint = "/home/useradmin/LXQ/Qwen2.5-Coder-7B-Instruct"
        # checkpoint = "/home/useradmin/LXQ/Qwen2.5-14B-Instruct-GPTQ-Int8"
        self.device = device
        print("开始读取qwen2")
        # self.tokenizer = AutoTokenizer.from_pretrained(checkpoint)
        # # self.model = AutoModelForCausalLM.from_pretrained(checkpoint, torch_dtype="auto").to(device)
    ...
    def generate(
        self, prompt, batch_size=1, temperature=1.2, max_length=3000
    ) -> List[str]:
